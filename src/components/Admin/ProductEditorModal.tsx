import { generateSeoTitle, generateSeoDescription, generateSeoH1, generateSeoKeywords, generateSeoAltText, generateCanonicalUrl, generateOpenGraph } from '../../utils/seoGenerator';
